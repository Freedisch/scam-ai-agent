  ...
  return (
    <>
      <div className="w-96 bg-white border-r border-gray-200 flex flex-col p-4 select-none h-screen overflow-y-auto">
        <div className="mb-6">
          <h2 className="text-black text-lg font-semibold">Call FastyCall</h2>
          <p className="text-gray-600 text-sm">To experience the future of 911 calls.</p>
        </div>
        ...
        <h3 className="text-black font-bold mb-2">Recent Emergency Calls</h3>
        ...
        <div className="flex-1">
          {sortedCalls.map((call) => {
            ...
            return (
              <div 
                key={call.id}
                className="mb-2 p-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer"
                onClick={() => onCallSelect(call)}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <IconToBeUsed size={26} className="text-black" />
                    <div>
                      <p className="text-gray-800">{call.shortSummary}</p>
